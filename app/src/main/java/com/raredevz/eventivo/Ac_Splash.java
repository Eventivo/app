...
public class Ac_Splash extends AppCompatActivity {
    ...
    private void handleLogin(){
        ...
        if (firebaseAuth.getCurrentUser()!=null){
            if (firebaseAuth.getCurrentUser().getUid().equals("7ySqjsOVdMaKb7FzuO83dzb7os22")){
                ...
                databaseReference.child("Manager").addValueEventListener(new ValueEventListener() {
                        ...
                        if (snapshot.hasChild(firebaseAuth.getUid())){
                            ...
                            if (manager.isApproved()){
                                if (manager.getStatus().equals(UserStatus.Enabled)){
                                 ...
                                 AlertMessage.showMessage(Ac_Splash.this,"Your account has been disabled by the admin!");
                                }
                            }else {
                                AlertMessage.showMessage(Ac_Splash.this,"You're not yet approved by the admin, please wait until admin approve your account.");
                            }
                        }else {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        startActivity(new Intent(Ac_Splash.this, Ac_Home.class));
