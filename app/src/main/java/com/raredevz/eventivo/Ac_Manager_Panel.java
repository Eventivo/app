...
//                }
                    ...
                    if (firebaseAuth.getCurrentUser()!=null){
                        try {
                            SettingsAPI set;
                            set = new SettingsAPI(Ac_Manager_Panel.this);
                    ...
                    if (FirebaseAuth.getInstance().getCurrentUser()!=null){
                        ...
                        Toast.makeText(Ac_Manager_Panel.this, "You'r logged out!", Toast.LENGTH_SHORT).show();
        ...
        Dref.child(Cons.node_venue).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                VenueAdapter_Vertical adapter=new VenueAdapter_Vertical(Ac_Manager_Panel.this, venueList);
                adapter.setClickListener(Ac_Manager_Panel.this);
